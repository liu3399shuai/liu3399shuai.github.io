...
+(instancetype)boxPointer:(void *)obj
{
    JPBoxing *boxing = [[JPBoxing alloc] init];
    boxing.pointer = obj;
    return boxing;
...
+(instancetype)boxClass:(Class)obj
{
    JPBoxing *boxing = [[JPBoxing alloc] init];
    boxing.cls = obj;
    return boxing;
...
//{ @"JPViewController" =     {
//    "_JPhandleBtn:" = "function () {\n                                  var args = _formatOCToJS(Array.prototype.slice.call(arguments))\n                                  var lastSelf = global.self\n                                  global.self = args[0]\n                                  if (global.self) global.self.__realClsName = realClsName\n                                  args.splice(0,1)\n                                  var ret = originMethod.apply(originMethod, args)\n                                  global.self = lastSelf\n                                  return ret\n        }";
//  };
//}

// 如上demo, key是类,value是个dic,这个dic里面，key是_JP方法名,value是js形式的function
...
+ (void)startEngine
{
    ...
    // formatJSToOC涉及到两个方法，_OC_formatJSToOC()(OC实现，JS调用，桥梁函数，参数是JSValue对象，在jscontext里)，formatJSToOC()(参数是OC对象，在JPEngine里,OC实现，OC调用)
    
    context[@"_OC_formatJSToOC"] = ^id(JSValue *obj) {
        return formatJSToOC(obj);
    };
    
    // formatOCToJS涉及到的有三个方法，一个是_formatOCToJS()(JS实现的,JS调用,在jscontext里),一个是_OC_formatOCToJS()(OC实现的，JS调用，桥梁函数，参数是JSValue对象，在jscontext里)，后者调用的是OC的方法formatOCToJS()(参数是OC对象，在JPEngine里,OC实现，OC调用)
    
    //    {
    //        "__clsName" = NSObject;
    //        "__obj" = "<NSObject: 0x60000000b460>";
    //    }
...
//            var color = UIColor.__c("blueColor")();
    //        var view = self.__c("view")();
    //        view.__c("setBackgroundColor")(color);
//    }
//    })
    
    //把这些js代码统一进行正则表达式的匹配替换，也就是把所有的函数都替换成对名为__c的函数的调用，也就是JPTableViewController.__c('alloc')().__c('init')(),而作者给 JS 对象基类 Object 的 prototype 加上 __c 成员
    
    NSString *code = [_regex stringByReplacingMatchesInString:script options:0 range:NSMakeRange(0, script.length) withTemplate:_replaceStr];
    
    NSString *formatedScript = [NSString stringWithFormat:@";(function(){try{\n%@\n}catch(e){_OC_catch(e.message, e.stack)}})();", code];
    ...
    for (NSString *jpSelector in groupDic.allKeys) {
        ...
        if (typeEncode) {
            ...
            if (!_protocolTypeEncodeDict) {
                ...
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(id)] forKey:@"id"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(BOOL)] forKey:@"BOOL"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(int)] forKey:@"int"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(void)] forKey:@"void"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(char)] forKey:@"char"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(short)] forKey:@"short"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(unsigned short)] forKey:@"unsigned short"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(unsigned int)] forKey:@"unsigned int"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(long)] forKey:@"long"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(unsigned long)] forKey:@"unsigned long"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(long long)] forKey:@"long long"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(float)] forKey:@"float"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(double)] forKey:@"double"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(CGFloat)] forKey:@"CGFloat"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(CGSize)] forKey:@"CGSize"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(CGRect)] forKey:@"CGRect"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(CGPoint)] forKey:@"CGPoint"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(CGVector)] forKey:@"CGVector"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(NSRange)] forKey:@"NSRange"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(NSInteger)] forKey:@"NSInteger"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(Class)] forKey:@"Class"];
                
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(SEL)] forKey:@"SEL"];
...
//                JP_DEFINE_TYPE_ENCODE_CASE(UIEdgeInsets);
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(UIEdgeInsets)] forKey:@"UIEdgeInsets"];
                
#else
                
//                JP_DEFINE_TYPE_ENCODE_CASE(NSEdgeInsets);
                [_protocolTypeEncodeDict setObject:[NSString stringWithUTF8String:@encode(NSEdgeInsets)] forKey:@"NSEdgeInsets"];
...
{
    // classDeclaration -> @"JPDispatch : JPExtension <UIAlertViewDelegate,UIScrollViewDelegate>"
...
// 每个方法默认有两个参数 一个是self，一个是selector，对应的typeencode分别是 @ :
...
//            JP_FWD_ARG_CASE('B', BOOL)
            ...
            case '{': {
                ...
                if ([typeString rangeOfString:@"CGRect"].location != NSNotFound) {
                    CGRect arg;
                    [invocation getArgument:&arg atIndex:i];
                    [argList addObject:[JSValue valueWithRect:arg inContext:_context]];
                    break;
                }
                
                if ([typeString rangeOfString:@"CGPoint"].location != NSNotFound) {
                    CGPoint arg;
                    [invocation getArgument:&arg atIndex:i];
                    [argList addObject:[JSValue valueWithPoint:arg inContext:_context]];
                    break;
                }
                ...
                if ([typeString rangeOfString:@"CGSize"].location != NSNotFound) {
                    CGSize arg;
                    [invocation getArgument:&arg atIndex:i];
                    [argList addObject:[JSValue valueWithSize:arg inContext:_context]];
                    break;
                }
                ...
                if ([typeString rangeOfString:@"NSRange"].location != NSNotFound) {
                    NSRange arg;
                    [invocation getArgument:&arg atIndex:i];
                    [argList addObject:[JSValue valueWithRange:arg inContext:_context]];
                    break;
                }
...
//        JP_FWD_RET_CASE_RET(':', SEL, JP_FWD_RET_CODE_SEL)
        ...
        case 'f' : {
            ...
            float ret = [[jsval toObject] floatValue];
            [invocation setReturnValue:&ret];
            break;
        }
...
static id callSelector(NSString *className, NSString *selectorName, JSValue *arguments, JSValue *instance, BOOL isSuper)
{
    ...
    for (NSUInteger i = 2; i < numberOfArguments; i++) {
        ...
        switch (argumentType[0] == 'r' ? argumentType[1] : argumentType[0]) {
            ...
            case 'C': {
                unsigned char value = [valObj unsignedCharValue];
                [invocation setArgument:&value atIndex:i];
                break;
            }
                
            case 's': {
                short value = [valObj shortValue];
                [invocation setArgument:&value atIndex:i];
                break;
            }
                
            case 'S': {
                unsigned short value = [valObj unsignedShortValue];
                [invocation setArgument:&value atIndex:i];
                break;
            }
            ...
            case 'I': {
                unsigned int value = [valObj unsignedIntValue];
                [invocation setArgument:&value atIndex:i];
                break;
            }
                
            case 'l': {
                long value = [valObj longValue];
                [invocation setArgument:&value atIndex:i];
                break;
            }
                
            case 'L': {
                unsigned long value = [valObj unsignedLongValue];
                [invocation setArgument:&value atIndex:i];
                break;
            }
            ...
            case 'Q': {
                unsigned long long value = [valObj unsignedLongLongValue];
                [invocation setArgument:&value atIndex:i];
                break;
            }
                
            case 'f': {
                float value = [valObj floatValue];
                [invocation setArgument:&value atIndex:i];
                break;
            }
                
            case 'd': {
                double value = [valObj doubleValue];
                [invocation setArgument:&value atIndex:i];
                break;
            }
    ...
    if (strncmp(returnType, "v", 1) != 0) {
        if (strncmp(returnType, "@", 1) == 0) {
            ...
            switch (returnType[0] == 'r' ? returnType[1] : returnType[0]) {
                ...
                case 'Q': {
                    unsigned long long tempResultSet;
                    [invocation getReturnValue:&tempResultSet];
                    returnValue = @(tempResultSet);
                    break;
                }
...
static id genCallbackBlock(JSValue *jsVal)
{
    ...
    id cb = ^id(void *p0, void *p1, void *p2, void *p3, void *p4, void *p5) {
        ...
        if (0 < argTypes.count) {
            NSString *argType = trim(argTypes[0]);
            if (blockTypeIsScalarPointer(argType)) {
                [list addObject:formatOCToJS([JPBoxing boxPointer:p0])];
            } else if (blockTypeIsObject(trim(argTypes[0]))) {
        ...
        if (1 < argTypes.count) {
            NSString *argType = trim(argTypes[1]);
            if (blockTypeIsScalarPointer(argType)) {
                [list addObject:formatOCToJS([JPBoxing boxPointer:p1])];
            } else if (blockTypeIsObject(trim(argTypes[1]))) {
                [list addObject:formatOCToJS((__bridge id)p1)];
            } else {
                [list addObject:formatOCToJS([NSNumber numberWithLongLong:(long long)p1])];
            }
        }

        if (2 < argTypes.count) {
            NSString *argType = trim(argTypes[2]);
            if (blockTypeIsScalarPointer(argType)) {
                [list addObject:formatOCToJS([JPBoxing boxPointer:p2])];
            } else if (blockTypeIsObject(trim(argTypes[2]))) {
                [list addObject:formatOCToJS((__bridge id)p2)];
            } else {
                [list addObject:formatOCToJS([NSNumber numberWithLongLong:(long long)p2])];
            }
        }

        if (3 < argTypes.count) {
            NSString *argType = trim(argTypes[3]);
            if (blockTypeIsScalarPointer(argType)) {
                [list addObject:formatOCToJS([JPBoxing boxPointer:p3])];
            } else if (blockTypeIsObject(trim(argTypes[3]))) {
                [list addObject:formatOCToJS((__bridge id)p3)];
            } else {
                [list addObject:formatOCToJS([NSNumber numberWithLongLong:(long long)p3])];
            }
        }

        if (4 < argTypes.count) {
            NSString *argType = trim(argTypes[4]);
            if (blockTypeIsScalarPointer(argType)) {
                [list addObject:formatOCToJS([JPBoxing boxPointer:p4])];
            } else if (blockTypeIsObject(trim(argTypes[4]))) {
                [list addObject:formatOCToJS((__bridge id)p4)];
            } else {
                [list addObject:formatOCToJS([NSNumber numberWithLongLong:(long long)p4])];
            }
        }

        if (5 < argTypes.count) {
            NSString *argType = trim(argTypes[5]);
            if (blockTypeIsScalarPointer(argType)) {
                [list addObject:formatOCToJS([JPBoxing boxPointer:p5])];
            } else if (blockTypeIsObject(trim(argTypes[5]))) {
                [list addObject:formatOCToJS((__bridge id)p5)];
            } else {
                [list addObject:formatOCToJS([NSNumber numberWithLongLong:(long long)p5])];
            }
        }
...
// obj 可能是 原始的OC对象，也可能是经过JPBox封装好的JPBox对象
